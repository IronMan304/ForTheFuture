...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form id="myForm" method="post" action="{{ route('service.store') }}" enctype="multipart/form-data">
        	@csrf

            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> Add Service</h5>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-3">
            ...
            <select name="service_category_id" class="form-select" id="example-select">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="avail_price" class="form-control "   >
