    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
<a href="{{ route('edit.service_category',$item->id) }}" class="btn btn-blue rounded-pill waves-effect waves-light">Edit</a>
<a href="{{ route('delete.service_category',$item->id) }}" class="btn btn-danger rounded-pill waves-effect waves-light" id="delete">Delete</a>
...
<div id="signup-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <form class="px-3" method="post" action="{{ route('service_category.store') }}">
                    @csrf
