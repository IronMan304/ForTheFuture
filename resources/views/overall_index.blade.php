...
@php
 ...
 $final_total = App\Models\ServiceOrder::sum('due');


 $completeorder = App\Models\Order::where('order_status','complete')->get(); 
 $servicecompleteorder = App\Models\ServiceOrder::where('service_order_status','complete')->get(); 

  $pendingorder = App\Models\Order::where('order_status','pending')->get(); 
  $servicependingorder = App\Models\ServiceOrder::where('service_order_status','pending')->get(); 

  $overall_total_expenses = $total_expenses + $finalTotal;
            ...
            <div class="row">
                ...
                <div class="col-6">
                   <div class="text-end">
                        ...
                        <h4 class="text-dark mt-1">₱ <span data-plugin="counterup">{{ $overall_total_expenses }}</span></h4>
                        <p >Revenues </p>
                    </div>
                </div>
            </div> <!-- end row-->
